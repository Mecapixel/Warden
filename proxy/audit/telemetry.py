"""
proxy/audit/telemetry.py  (v1.5.4)
...
Usage:
    python -m proxy.cli stats                # table
    python -m proxy.cli stats --json         # machine-readable
    python -m proxy.cli stats --top 5        # limit per-tool/rule listings
