"""
warden/inspect/threats.py  (v2 — Model Security)
...
from warden.inspect.inbound import InjectionSignal, _excerpt
from warden.core.textnorm import harden, _INVISIBLES
