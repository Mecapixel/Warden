...
from warden.inspect import inbound, redactor, threats
from warden.runtime.approval import ApprovalGate, ApprovalHistory
from warden.network.ratelimit import RateLimiter
from warden.network.canary import CanaryVault
from warden.network import downloads as download_guard
from warden.network import httpguard
...
class Mediator:
    ...
    def sessions(self):
        if self._sessions is None:
            from warden.identity.sessions import SessionManager
